            ...
            <div className='bg-white px-8 py-8 border rounded w-full max-w-4xl max-h-[80vh] overflow-y-scroll'>
                ...
                <div className='mt-4 flex flex-col lg:flex-row items-start gap-10 text-gray-600'>
                    ...
                    <div className='w-full lg:flex-1 flex flex-col gap-4'>
                        ...
                        <div className='flex-1 flex flex-col gap-1'>
                            <p>Experience</p>
                            <select className='border rounded px-3 py-2.5' name="" id="">
                ...
                <div>
                    ...
                    <textarea className='w-full px-4 pt-2 border rounded' type="text" placeholder='write about doctor...' rows={5} required />
                </div>
