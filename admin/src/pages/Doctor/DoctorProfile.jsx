        ...
        <div className="md:w-2/5 bg-slate-50/50 p-8 sm:p-10 flex flex-col items-center text-center md:border-r border-gray-100 relative overflow-hidden">
          ...
          <div className="relative mb-6 group">
            ...
            <img
              ...
              src={profileData.image || "/default_image.png"}
          ...
          <div>
            ...
            <div className="mb-8">
              <h3 className="text-lg font-bold text-gray-700 mb-3 flex items-center">
                About Me
                <span className="block ml-3 h-[3px] w-12 bg-primary/30 rounded-full"></span>
              </h3>
            ...
            {/* Available Status */}
            <div className={`flex items-center gap-3 p-4 rounded-2xl transition-colors ${isEdit ? 'bg-primary/[0.04] border border-primary/20' : 'bg-gray-50 border border-gray-100'}`}>
               
               <div className={`w-3 h-3 rounded-full ${profileData.available ? 'bg-green-500 shadow-[0_0_8px_rgba(34,197,94,0.5)]' : 'bg-gray-400'}`}></div>
               
              <label htmlFor="available-checkbox" className="flex-1 text-gray-700 font-medium cursor-pointer select-none">
