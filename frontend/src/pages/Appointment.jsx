            ...
            {docSlots.length &&
              docSlots.map((item, index) => (
                <div
                  ...
                  key={index}
                  className={`text-center py-6 min-w-16 rounded-full cursor-pointer border transition-all duration-200 ${slotIndex === index ? "bg-primary text-white" : "border border-gray-200"}`}
                >
            ...
            {docSlots.length &&
              docSlots[slotIndex].map((item, index) => (
                <p
                  ...
                  className={`text-sm font-light flex-shrink-0 px-5 py-2 rounded-full cursor-pointer border transition-all duration-200 ${item.time === slotTime ? "bg-primary text-white" : "text-gray-400 border border-gray-300"}`}
                  key={index}
                >
